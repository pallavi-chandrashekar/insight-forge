...
class Context(Base):
    ...
    parsed_yaml = Column(JSONType, nullable=False)      # Parsed YAML frontmatter

    # Cached parsed structures for performance
    datasets = Column(JSONType, nullable=False)          # Array of dataset definitions
    relationships = Column(JSONType, nullable=True)      # Array of relationships
    metrics = Column(JSONType, nullable=True)            # Array of metrics
    business_rules = Column(JSONType, nullable=True)     # Array of business rules
    filters = Column(JSONType, nullable=True)            # Array of filters
    settings = Column(JSONType, nullable=True)           # Context settings

    # New rich metadata fields
    data_model = Column(JSONType, nullable=True)         # ER diagram and entities
    glossary = Column(JSONType, nullable=True)           # Business term definitions
    ...
    validation_errors = Column(JSONType, nullable=True)  # Validation error details
    validation_warnings = Column(JSONType, nullable=True) # Validation warnings
...
class QueryContext(Base):
    ...
    used_relationships = Column(JSONType, nullable=True)  # Array of relationship IDs used
    used_metrics = Column(JSONType, nullable=True)        # Array of metric IDs used
    used_filters = Column(JSONType, nullable=True)        # Array of filter IDs used
